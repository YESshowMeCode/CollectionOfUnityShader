...
// ----------------------------------------------------------------------------
// Reflection Probes
// 在HLSLSupport.cginc文件中
UNITY_DECLARE_TEXCUBE(unity_SpecCube0); // 声明了一个TextureCube类型的对象
UNITY_DECLARE_TEXCUBE_NOSAMPLER(unity_SpecCube1); //声明了一个TextureCube类型的对象（无Sampler）
